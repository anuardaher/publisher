<template>
  <div class="article">
    <v-row align="center" justify="center">
      <v-col md="9" lg="9" xl="6" xs="12">
        <v-sheet tile :class="sheetClass" max-width="100%" elevation="4">
          ...
          <v-row align="center" justify="center">
            <div class="text-center my-1">
              ...
              <v-chip class="mb-2" label small>
                <div>
                  <span class="body-2">{{ article.author.profession }}</span>
                </div>
              </v-chip>
              <div v-if="article.author.bio">
          ...
          <client-only>
            ...
            <script
              ...
              data-width="100%"
              src="https://connect.facebook.net/pt_BR/sdk.js#xfbml=1&version=v5.0&appId=365056554418853&autoLogAppEvents=1"
            ></script>
            <v-row id="facebook-comments" align="center" justify="center">
              <div
                class="fb-comments"
                :data-href="BASE_URL + $route.path"
                data-numposts="5"
              ></div>
            </v-row>
          </client-only>
